...
export class GalleryController {
  ...
  @ApiResponse({ status: 201, description: 'Gallery item created', type: GalleryItem })
  ...
  @ApiResponse({ status: 200, description: 'Gallery item found', type: GalleryItem })
  ...
  @ApiParam({ name: 'id', description: 'MongoDB ObjectId', type: String })
  @ApiResponse({ status: 200, description: 'Gallery item updated', type: GalleryItem })
  update(
    @Param('id') id: string,
  ...
  @ApiParam({ name: 'id', description: 'MongoDB ObjectId', type: String })
  @ApiResponse({ status: 200, description: 'Gallery item deleted', type: GalleryItem })
